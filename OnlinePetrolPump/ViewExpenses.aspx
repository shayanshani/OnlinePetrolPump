<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.Master" CodeBehind="ViewExpenses.aspx.cs" Inherits="OnlinePetrolPump.ViewExpenses" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#formPopUp1">Add Expense Head</button>
                             ...
                             <a href="ViewAllExpenses.aspx" class="btn btn-success">View All Expense</a>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <label>
                                                                Select Head :&nbsp;
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" InitialValue="-1" runat="server" ValidationGroup="Validation" ControlToValidate="ddlHead" Display="Dynamic" ErrorMessage="*" CssClass="has-error"></asp:RequiredFieldValidator>
                                                            </label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <asp:Button ID="btnShowReport" runat="server" OnClientClick="if (!Page_ClientValidate('Val1')){ return false; } this.disabled = true; this.value = 'Please wait...';" UseSubmitBehavior="false" Text="Show" OnClick="btnShowReport_Click" CssClass="btn btn-primary" ValidationGroup="Val1" />
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td><%# Eval("ExpenseDate","{0:dd/MM/yyyy}") %></td>
                                         ...
                                         <td id="tdActionsHeads" runat="server">
                                            ...
                                            &nbsp; | &nbsp;
                                            <asp:LinkButton ID="btnDeleteExpense" runat="server" CommandArgument='<%# Eval("ExpenseID") %>' OnClick="btnDeleteExpense_Click" Style="font-size: 15px!important" OnClientClick="return confirm('Are you sure you want to delete this Expense?')">
                                                <i class="fa fa-trash"></i>
                                            </asp:LinkButton>
                                        </td>
                                    </tr>
