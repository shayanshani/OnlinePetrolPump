...
namespace OnlinePetrolPump.BL
{
	...
	public partial class TblExpense : ActiveRecord<TblExpense>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int? varHeadID,string varTitle,int? varAmount,string varDescription,DateTime? varExpenseDate,DateTime? varDateX,int? varUpdateBy)
		{
		...
		/// </summary>
		public static void Update(int varExpenseID,int? varHeadID,string varTitle,int? varAmount,string varDescription,DateTime? varExpenseDate,DateTime? varDateX,int? varUpdateBy)
		{
			TblExpense item = new TblExpense();
