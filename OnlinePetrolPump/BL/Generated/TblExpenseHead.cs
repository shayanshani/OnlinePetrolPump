...
namespace OnlinePetrolPump.BL
{
	...
	public partial class TblExpenseHead : ActiveRecord<TblExpenseHead>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_ExpenseHeads", TableType.Table, DataService.GetInstance("OnlinePetrolPump"));
				...
				DataService.Providers["OnlinePetrolPump"].AddSchema("tbl_ExpenseHeads",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varHead)
		{
		...
		/// </summary>
		public static void Update(int varHeadID,string varHead)
		{
			TblExpenseHead item = new TblExpenseHead();
