...
namespace OnlinePetrolPump.BL
{
	...
	public partial class TblAdmin : ActiveRecord<TblAdmin>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_Admins", TableType.Table, DataService.GetInstance("OnlinePetrolPump"));
				...
				DataService.Providers["OnlinePetrolPump"].AddSchema("tbl_Admins",schema);
			}
		}
		#endregion
