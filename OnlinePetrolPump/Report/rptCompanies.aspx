<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptCompanies.aspx.cs" Inherits="OnlinePetrolPump.Report.rptCompanies" %>
    ...
    <form id="form1" runat="server">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" class="grand total">TOTAL CREDIT :</td>
