...
{
    public partial class ViewExpenses : Helper.SpartansHelper
    {
        ...
        {
            string query = "select * from vw_Expenses where ExpenseDate='" + getDateTime().ToString("MM/dd/yyyy") + "'";
        ...
        protected void rptExpenses_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            //    if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            //    {
            //        HtmlTableCell tdActions = (HtmlTableCell)e.Item.FindControl("tdActionsHeads");
            //        if (isAdmin)
            //            tdActions.Visible = true;
            //    }
        }
